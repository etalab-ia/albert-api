...
| swagger_summary | string | Display summary of your API in swagger UI, see https://fastapi.tiangolo.com/tutorial/metadata for more information. |  | OpenGateLLM connect to your models.                                                                                                    |  | OpenGateLLM connect to your models. |
...
| swagger_title | string | Display title of your API in swagger UI, see https://fastapi.tiangolo.com/tutorial/metadata for more information. |  | OpenGateLLM                                                                                                                             |  | OpenGateLLM |
