...
from ui.backend.documents import create_collection, upload_document, create_collection_with_id


def parse_document(file, output_format: str = "markdown", force_ocr: bool = False, 
                  page_range: str = "", paginate_output: bool = False) -> dict:
    """
    ...
    response = requests.post(
        url=f"{settings.playground.api_url}/v1/parse-beta",
        files=files,
        data=data,
