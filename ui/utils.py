...
def generate_stream(messages: List[dict], params: dict, api_key: str, rag: bool, rerank: bool) -> Tuple[str, List[str]]:
    ...
    if rag:
        ...
        prompt_template = "Réponds à la question suivante de manière claire en te basant sur les documents ci-dessous. Si les documents ne sont pas pertinents pour répondre à la question, réponds que tu ne sais pas ou réponds directement la question à l'aide des connaissances. Réponds en français.\nLa question de l'utilisateur est : {prompt}\n\nLes documents sont :\n{chunks}"
