...
class TestAuth:
    def test_create_role_with_user_token(self, client: TestClient):
        ...
        response = client.post_user(url="/roles", json={"role": "new-role", "default": False, "admin": False, "limits": []})
    ...
    def test_create_already_existing_role_with_user_token(self, client: TestClient):
        ...
        response = client.post_user(url="/roles", json={"role": "test-role-user", "default": False, "admin": False, "limits": []})
        assert response.status_code == 403, response.text
    ...
    def test_update_role_with_user_token(self, client: TestClient):
        ...
        response = client.patch_user(url="/roles/test-role-user", json={"role": "test-role-user", "default": False, "admin": True, "limits": []})
        assert response.status_code == 403, response.text
    ...
    def test_delete_role_with_user_token(self, client: TestClient):
        ...
        response = client.delete_user(url="/roles/test-role-user")
        assert response.status_code == 403, response.text
    ...
    def test_delete_inexistent_role_with_user_token(self, client: TestClient):
        ...
        response = client.delete_user(url="/roles/inexistent-role")
        assert response.status_code == 403, response.text
    ...
    def test_create_user_with_user_token(self, client: TestClient):
        ...
        response = client.post_user(url="/users", json={"user": "new-user", "password": "test-password", "role": "test-role-user"})
        assert response.status_code == 403, response.text
    ...
    def test_create_already_existing_user_with_user_token(self, client: TestClient):
        ...
        response = client.post_user(url="/users", json={"user": "test-user-user", "password": "test-password", "role": "test-role-user"})
        assert response.status_code == 403, response.text
    ...
    def test_create_inexistent_user_with_user_token(self, client: TestClient):
        ...
        response = client.post_user(url="/users", json={"user": "new-user", "password": "test-password", "role": "inexistent-role"})
        assert response.status_code == 403, response.text
    ...
    def test_delete_user_with_user_token(self, client: TestClient):
        """Test forbidden access to the DELETE /users endpoint with user token to check if user cannot delete a user."""
        response = client.delete_user(url="/users/test-user-user")
        assert response.status_code == 403, response.text
    ...
    def test_delete_inexistent_user_with_user_token(self, client: TestClient):
        ...
        response = client.delete_user(url="/users/inexistent-user")
        assert response.status_code == 403, response.text
    ...
    def test_create_token_with_user_token(self, client: TestClient):
        ...
        response = client.post_user(url="/tokens", json={"user": "test-user-user", "token": "test-token"})
        assert response.status_code == 403, response.text
    ...
    def test_create_token_with_inexistent_user_token(self, client: TestClient):
        ...
        response = client.post_user(url="/tokens", json={"user": "inexistent-user", "token": "test-token"})
        assert response.status_code == 403, response.text
    ...
    def test_delete_token_with_user_token(self, client: TestClient):
        ...
        response = client.delete_user(url="/tokens/test-user-user/test-token-user")
        assert response.status_code == 403, response.text
    ...
    # def test_delete_master_role_with_admin_token(self, client: TestClient):
    #     """Test the DELETE /roles endpoint with admin token to check if master role cannot be deleted."""
    ...
    #     # delete the user
    #     response = client.delete_admin(url="/users/test-user")
    #     assert response.status_code == 204, response.text
