...
def setup(client):
    ...
    response = client.get_without_permissions("/v1/models")
...
class TestUsagesMiddleware:
    def test_log_chat_completion(self, client, setup, db_session):
        ...
        response = client.post_without_permissions("/v1/chat/completions", json=params)
    ...
    def test_log_embeddings(self, client, db_session):
        ...
        response = client.post_without_permissions("/v1/embeddings", json=params)
        assert response.status_code == 200
    ...
    def test_log_with_invalid_json(self, client, db_session):
        ...
        response = client.post("/v1/chat/completions", data=invalid_json, headers={"Content-Type": "application/json"})
