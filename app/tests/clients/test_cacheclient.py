...
#             call("Cache version mismatch. Stored: None, Current: 2.0.0. Flushing cache."),
#             call("Cache flushed and version updated to 2.0.0"),
#         ])
...
#         mock_async_init.assert_called_once_with(connection_pool=connection_pool)
#         mock_logger.assert_has_calls([
#             call("Cache version mismatch. Stored: 1.0.0, Current: 2.0.0. Flushing cache."),
#             call("Cache flushed and version updated to 2.0.0"),
#         ])
