...
async def ocr(file: UploadFile = File(...), request: OCRRequest = None, user: User = Security(check_api_key)):
    """
    ...
    if request is None:
        request = OCRRequest(model="mistralai/Mistral-Small-3.1-24B-Instruct-2503", dpi=150)
